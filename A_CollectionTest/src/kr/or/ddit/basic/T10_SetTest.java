...
//		TreeSet에 저장된 자료 중 특정한 자료보다 작은 자료를 찾아서 SortedSet으로 변한하는 메소드가 있다.
//		=> headSet(기준값) 메소드 (기본적으로 '기준값'은 포함시키지 않는다)
