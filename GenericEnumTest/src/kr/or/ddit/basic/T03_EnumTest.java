...
public class T03_EnumTest {
	...
	/*
		...
		2. ordinal() => 열거형 상수가 정의된 순서값을 반환한다. (기본적으로 0부터)
		3. valueOf("열거형상수이름"); =>지정된 열거형에서 '열거형상수이름'과 일치하는 열거형 상수를 반환한다.
	 */
		City myCity1; // 열거형 변수 선언
		City myCity2;
		
		// 열거형 객체변수에 값 저장하기
		myCity2 = City.서울;
		myCity1 = City.valueOf("서울"); // City enum에서 '서울'인 객체
		System.out.println(City.valueOf("서울") + " " + City.서울);
		...
		System.out.println("get() => " + ss.getStr());
		System.out.println("----------------------------------------------");
