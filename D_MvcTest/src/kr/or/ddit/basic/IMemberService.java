...
/**
 * Service에서는 Dao에 생성된 메소드를 원하는 작업에 맞게 호출하여 결과를 받아오고,
...
public interface IMemberService {
	...
	/**
	 * 하나의 MemverVO자료를 이용하여 DB를 update하는 메소드
	 * @param mv  update할 회원벙조가 들어있는 MemberVO객체
	...
	/**
	 * MemberVO 객체에 담긴 자료를 이용하여 회원을 검색하는 메소드
